...
| recall_at_10_mean | 0.525 | 0.483 | -0.042 |
| mrr_mean | 0.489 | 0.431 | -0.058 |
...
| metric | cold | warm | Δ |
|---|---:|---:|---:|
| answer_found_rate | 65.00% | 85.00% | +20.00% |
| memory_primary_rate | 0.00% | 80.00% | +80.00% |
| primary_hit_rate | 65.00% | 60.00% | -5.00% |
| primary_top1 | 45.00% | 30.00% | -15.00% |
| primary_top5 | 65.00% | 60.00% | -5.00% |
| recall_at_10_mean | 0.433 | 0.450 | 0.017 |
| mrr_mean | 0.512 | 0.412 | -0.100 |

## Paraphrase — non-leaky subset

| metric | cold | warm | Δ |
|---|---:|---:|---:|
| answer_found_rate | 60.00% | 80.00% | +20.00% |
| memory_primary_rate | 0.00% | 73.33% | +73.33% |
| primary_hit_rate | 60.00% | 53.33% | -6.67% |
| primary_top1 | 33.33% | 26.67% | -6.67% |
| primary_top5 | 60.00% | 53.33% | -6.67% |
| recall_at_10_mean | 0.311 | 0.333 | 0.022 |
| mrr_mean | 0.416 | 0.349 | -0.067 |
