...
| metric | cold | warm | Δ |
|---|---:|---:|---:|
| answer_found_rate | 75.00% | 95.00% | +20.00% |
...
| recall_at_10_mean | 0.613 | 0.596 | -0.017 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| S1 | low | 5 | 3 | +2 | 0.00 | 0.00 | 0 |
| S2 | low | 1 | 1 | +0 | 0.25 | 0.25 | 0 |
| S3 | low | — | — |  | 0.00 | 0.00 | 0 |
| S4 | low | — | — |  | 0.00 | 0.00 | 0 |
| S5 | low | 4 | 4 | +0 | 0.67 | 0.67 | 0 |
| F1 | low | 3 | 3 | +0 | 0.50 | 0.50 | 0 |
| F2 | low | 1 | 1 | +0 | 0.33 | 0.33 | 0 |
